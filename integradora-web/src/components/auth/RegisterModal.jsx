...
const RegisterModal = ({ isOpen, onClose, onSwitchToLogin }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] overflow-y-auto" style={{ fontFamily: "'Montserrat', sans-serif" }}>
            {/* Backdrop */}
            <div
            ...
            {/* Modal Container for Scroll and Centering */}
            <div className="flex min-h-full items-center justify-center p-4 sm:p-6">
                {/* Modal Content */}
                <div className="relative bg-white rounded-[2.5rem] shadow-2xl overflow-hidden max-w-5xl w-full flex flex-col lg:flex-row min-h-[550px] animate-in fade-in zoom-in duration-300 my-8">
                    ...
                    <div className="w-full lg:w-1/2 bg-[#F3F0E7] flex flex-col justify-between p-10 relative">
                        ...
                        {/* Center Brand */}
                        <div className="flex items-baseline justify-center py-10 lg:py-0">
                    ...
                    {/* Right Side - Form */}
                    <div className="w-full lg:w-1/2 bg-white flex flex-col justify-center px-10 py-10 lg:px-16 relative">
                        <div className="max-w-md w-full mx-auto">
                            <h2 className="text-3xl font-bold text-black mb-6">Registro</h2>
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="w-full flex items-center justify-center px-6 py-3 border border-gray-300 rounded-xl text-base font-bold text-black bg-white hover:bg-gray-50 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
